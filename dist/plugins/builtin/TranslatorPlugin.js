 ...
 */
export default class TranslatorPlugin {
    constructor() {
        this.metadata = {
            id: 'translator',
        ...
        return [
            {
                ...
                parameters: [
                    ...
                    {
                        name: 'targetLang',
                        description: 'Target language code (e.g., "en", "zh", "es", "fr", "de", "ja", "ko")',
    ...
    async translate(params) {
        ...
        try {
            ...
            const sourceLangName = (parsed.sourceLang && this.supportedLanguages.get(parsed.sourceLang)) || 'Auto-detected';
            const targetLangName = this.supportedLanguages.get(parsed.targetLang);
            this.context.log('info', `Translating from ${sourceLangName} to ${targetLangName}`);
