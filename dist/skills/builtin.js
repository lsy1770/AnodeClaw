 ...
 */
export const screenshotAnalyzeSkill = {
 ...
 */
export const findAndClickSkill = {
    id: 'find-and-click',
    name: 'Find & Click',
 ...
 */
export const httpFetchSaveSkill = {
    id: 'http-fetch-save',
    ...
    steps: [
        ...
        {
            name: 'save',
            condition: (ctx) => !!ctx.params.savePath,
            tool: 'write_file',
            params: {
                path: '${params.savePath}',
                content: '${fetch.data}',
 ...
 */
export const swipeNavigationSkill = {
    id: 'swipe-navigate',
            ...
            handler: async (ctx) => {
                ...
                switch (direction) {
                    case 'up': // scroll content up (finger moves up)
                        startX = centerX;
                        startY = centerY + swipeLength / 2;
                        endX = centerX;
                        endY = centerY - swipeLength / 2;
                        break;
                ...
                const auto = globalThis.auto;
                if (auto && auto.swipe) {
                    await auto.swipe(Math.round(startX), Math.round(startY), Math.round(endX), Math.round(endY), duration);
                }
                else {
                    throw new Error('AutomatorAPI not available');
                }
 ...
 */
export const scrollFindClickSkill = {
 ...
 */
export const deviceStatusSkill = {
    id: 'device-status',
    name: 'Device Status',
