...
export class SessionList {
  ...
  private onDeleteSessionCallback?: (sessionId: string) => void;
   ...
   */
  async show(config: SessionListConfig = {}): Promise<void> {
    if (this.isVisible) {
   ...
   */
  onDeleteSession(callback: (sessionId: string) => void): void {
  ...
  private setupEventListeners(): void {
    ...
    const longClickSuccess = floatingWindow.on('longClick', (event: any) => {
   ...
   */
  private showSessionOptions(sessionId: string): void {
