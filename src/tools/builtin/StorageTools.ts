...
// Anode storage global (based on anode-api.d.ts)
declare const storage: {
  getItem(key: string, defaultValue?: any | null): Promise<any>;
  getItemSync(key: string, defaultValue?: any | null): any | null;
  setItem(key: string, value?: any | null): Promise<any>;
  setItemSync(key: string, value?: any | null): boolean;
 ...
 */
export const getStorageItemTool: Tool = {
  name: 'storage_get',
 ...
 */
export const setStorageItemTool: Tool = {
  name: 'storage_set',
 ...
 */
export const removeStorageItemTool: Tool = {
  name: 'storage_remove',
 ...
 */
export const hasStorageKeyTool: Tool = {
  name: 'storage_has',
 ...
 */
export const listStorageKeysTool: Tool = {
  name: 'storage_keys',
 ...
 */
export const getAllStorageTool: Tool = {
 ...
 * Clear Storage Tool
 */
export const clearStorageTool: Tool = {
  name: 'storage_clear',
