...
declare const image: {
  ...
  loadBase64(base64: string): Promise<any>;
  saveImage(bitmap: any | null, path: string, format?: string, quality?: number): Promise<boolean>;
  toBase64(bitmap: any | null, format?: string, quality?: number): Promise<string>;
  resize(bitmap: any | null, width: number, height: number): Promise<any>;
  crop(bitmap: any | null, x: number, y: number, width: number, height: number): Promise<any>;
  rotate(bitmap: any | null, degrees: number): Promise<any>;
  flip(bitmap: any | null, horizontal?: boolean): Promise<any>;
  findImage(source: any | null, template: any | null, threshold?: number, region?: any | null, method?: string): Promise<any>;
  findAllImages(source: any | null, template: any | null, threshold?: number, region?: any | null, maxResults?: number): Promise<any[]>;
  findColor(bitmap: any | null, color: string, threshold?: number, region?: any | null, method?: string): Promise<any>;
  findAllColors(bitmap: any | null, color: string, threshold?: number, method?: string): Promise<any[]>;
  findColorHSV(bitmap: any | null, color: string, threshold?: number, region?: any | null): Promise<any>;
  ...
  releaseScreenCapture(): Promise<any>;
  gaussianBlur(bitmap: any | null, kernelSize?: number): Promise<any>;
  cannyEdgeDetection(bitmap: any | null, lowThreshold?: number, highThreshold?: number): Promise<any>;
  histogramEqualization(bitmap: any | null): Promise<any>;
};
 ...
 * Flip Image Tool
 */
export const flipImageTool: Tool = {
  name: 'flip_image',
 ...
 */
export const findAllImagesTool: Tool = {
 ...
 * Find Color Tool
 */
export const findColorTool: Tool = {
  name: 'find_color',
 ...
 * Gaussian Blur Tool
 */
export const gaussianBlurTool: Tool = {
  name: 'gaussian_blur',
 ...
 * Edge Detection Tool
 */
export const edgeDetectionTool: Tool = {
  name: 'edge_detection',
