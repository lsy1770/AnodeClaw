...
// Anode device global (based on anode-api.d.ts)
declare const device: {
  getDeviceInfo(): Record<string, any>;  // Synchronous!
  getScreenWidth(): Promise<number>;
  getScreenHeight(): Promise<number>;
  isScreenOn(): boolean;  // Synchronous!
  keepScreenOn(on?: boolean): Promise<any>;
  getBrightness(): Promise<number>;
  setBrightness(brightness: number): Promise<any>;
  setVolume(volume: number, streamType?: number): Promise<any>;
  getMaxVolume(streamType?: number): number;  // Synchronous!
  getVolume(streamType?: number): number;  // Synchronous!
  isMuted(streamType?: number): boolean;  // Synchronous!
  vibrate(duration: number): Promise<any>;
  cancelVibration(): Promise<any>;
  isWifiEnabled(): boolean;  // Synchronous!
  setWifiEnabled(enabled: boolean): Promise<any>;
  getWifiSignalLevel(): number;  // Synchronous!
  getBatteryInfo(): Record<string, any>;  // Synchronous!
  getStorageInfo(): Record<string, string>;  // Synchronous!
  getMemoryInfo(): Record<string, string>;  // Synchronous!
};

// Anode globalApi (based on anode-api.d.ts)
declare const globalApi: {
  toast(message: string, duration?: string): void;  // Synchronous, void
  setClipboard(text: string, label?: string): void;  // Synchronous
  getClipboard(): string | null;  // Synchronous
  openSettings(settingType?: string): void;  // Synchronous
  setScreenOrientation(orientation: string): void;  // Synchronous
};

// Anode auto (based on anode-api.d.ts)
declare const auto: {
 ...
 */
export const getBatteryInfoTool: Tool = {
 ...
 */
export const getMemoryInfoTool: Tool = {
 ...
 * Show Toast Tool
 */
export const showToastTool: Tool = {
  name: 'show_toast',
 ...
 */
export const getCurrentAppTool: Tool = {
 ...
 * Set Clipboard Tool
 */
export const setClipboardTool: Tool = {
  name: 'set_clipboard',
 ...
 * Get Clipboard Tool
 */
export const getClipboardTool: Tool = {
  name: 'get_clipboard',
 ...
 * Set Volume Tool
 */
export const setVolumeTool: Tool = {
  name: 'set_volume',
 ...
 * Keep Screen On Tool
 */
export const keepScreenOnTool: Tool = {
  name: 'keep_screen_on',
