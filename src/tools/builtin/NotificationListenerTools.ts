...
// Anode notificationListener global (based on NotificationListenerAPI.kt)
declare const notificationListener: {
    ...
    on(eventType: string, callback: Function): number;
    once(eventType: string, callback: Function): number;
    off(listenerId: number): boolean;
    removeAllListeners(): void;
    setFilter(packageNames: string[] | null): void;
    getActiveNotifications(): Promise<any[]>;
    getActiveNotificationsFiltered(packageName: string | null): Promise<any[]>;
    cancelNotification(key: string): Promise<boolean>;
    cancelNotificationsByPackage(packageName: string): Promise<number>;
};

/**
 * Check Notification Listener Status Tool
 */
export const checkNotificationListenerStatusTool: Tool = {
 ...
 */
export const openNotificationListenerSettingsTool: Tool = {
 ...
 */
export const getActiveNotificationsTool: Tool = {
 ...
 */
export const setNotificationFilterTool: Tool = {
 ...
 */
export const cancelNotificationsByPackageTool: Tool = {
 ...
 */
export const removeNotificationListenerTool: Tool = {
 ...
 */
export const removeAllNotificationListenersTool: Tool = {
 ...
 */
export const notificationListenerTools: Tool[] = [
