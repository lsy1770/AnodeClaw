...
import { SubAgentCoordinator } from '../../core/subagents/SubAgentCoordinator.js';
import { logger } from '../../utils/logger.js';

let _coordinator: SubAgentCoordinator | undefined;

export function setSubAgentCoordinator(coordinator: SubAgentCoordinator) {
...
export const createSubAgentTool: Tool = {
    ...
    execute: async ({ name, role, systemPrompt, tools }) => {
        ...
        const agent = _coordinator.createAgent({
            id,
            name,
            role: role as any, // Cast to AgentRole
