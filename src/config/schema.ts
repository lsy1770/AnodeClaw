...
export const AgentConfigSchema = z.object({
  defaultSystemPrompt: z.string().default(
    'You are a helpful AI assistant running on an Android device. You have access to various tools to help users automate tasks and interact with their device.'
  ),
