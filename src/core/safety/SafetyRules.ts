...
import type { DangerousPattern, RiskLevel, CommandCategory } from './types.js';
 ...
 */
export function getToolBaseRisk(toolName: string): RiskLevel {
...
export function requiresApproval(
  riskLevel: RiskLevel,
  trustMode: 'strict' | 'moderate' | 'permissive' | 'yolo'
): boolean {
  switch (trustMode) {
    case 'yolo':
