...
export class SkillLoader {
    static async loadSkillsFromDir(dir: string, source: SkillEntry['source']): Promise<SkillEntry[]> {
    ...
    private static parseSkillFile(fileContent: string): { metadata: any, content: string } | null {
